							...
							<div class="container">
								...
								<div class="card card-custom">
									<div class="card-header flex-wrap py-2">
										<form action="<?php echo base_url(); ?>mpi/kas"  method="get" enctype="multipart/form-data">
...
<table class="table table-separate table-head-custom table-checkable" id="kt_datatable">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><span onclick="openFullScreenPopupWithFocus('<?php echo prefix_url;?>mpi/invDetail?invoice_no=<?php echo $dt->NoInvoice; ?>')" class="btn btn-primary btn-sm">View</span></td>
...
<form action="<?php echo base_url(); ?>mpi/upload_kas"  method="post" enctype="multipart/form-data">
