							...
							<div class="container">
								...
								<div class="card card-custom">
									<div class="card-header flex-wrap py-2">
										<form action="<?php echo base_url(); ?>nagoya/order"  method="get" enctype="multipart/form-data">
  ...
  <div class="modal-dialog modal-lg">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
				...
				<form action="<?php echo base_url(); ?>nagoya/uplpoad_data_cetak"  method="post" enctype="multipart/form-data">
