							...
							<div class="container">
								...
								<div class="card card-custom">
									<div class="card-header flex-wrap py-2">
										<form action="<?php echo base_url(); ?>pos/order"  method="get" enctype="multipart/form-data">
									...
									<div class="card-body">
                  <a href="<?php echo base_url(); ?>format" target="_BLANK">FORMAT UPLOAD</a><hr>
										<?php if($check=='EXPORT'){ ?>
										<a href="<?php echo base_url(); ?><?php echo $file_name; ?>" download>Download</a><hr>
										<?php } ?>
										<!--begin: Datatable-->
  ...
  <div class="modal-dialog modal-lg">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
				...
				<form action="<?php echo base_url(); ?>pos/uplpoad_data_cetak"  method="post" enctype="multipart/form-data">
